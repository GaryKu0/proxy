...
function afficher_page_form($page) {
	...
	echo '  <link rel="shortcut icon" href="https://sususu.su/about/touch-icon-iphone-retina.png" />' . "\n";
	echo '	<title>SU網頁翻牆器</title>'."\n";
	echo '	<meta name="robots" content="noindex, nofollow" />'."\n";
	echo '<style type="text/css">'."\n";

	echo 'body { background:#ffffff; width: 100%; margin:0; padding:0; }
